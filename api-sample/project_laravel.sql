...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 30, 2020 at 06:39 AM
...
CREATE TABLE `listbuku` (
  ...
  `namabuku` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `listbuku` (`id`, `namabuku`, `harga`) VALUES
(1, 'Buku 2', 10000.00),
(4, 'Buku5', 170000.00),
(5, 'Buku 6', 12000.00);
...
(3, '2020_07_16_113758_create_listbuku_table', 2);
